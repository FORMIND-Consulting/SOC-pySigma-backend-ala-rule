...
def alarule_pipeline():  # Processing pipelines should be defined as functions that return a ProcessingPipeline object.
    return ProcessingPipeline(
        name="ala-rule example pipeline",
        ...
        items=[
            ProcessingItem(  # This is an example for processing items generated from the mapping above.
                identifier=f"alarule_windows_{service}",
        ...
        + [
            ProcessingItem(  # Field mappings
                identifier="alarule_field_mapping",
